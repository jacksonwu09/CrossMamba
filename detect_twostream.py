...
def detect(opt):
    ...
    for (path, img, im0s, vid_cap), (path_, img2, im0s_, vid_cap_) in zip(dataset, dataset2):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            #
            # ---------------------------------------------------------------------------
            annoPath = "/root/autodl-tmp/CrossMamba/datasets/FLIR-align-3class/labels/test/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/autodl-tmp/CrossMamba/saves/FLIR_CrossMamba/CrossMamba3/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='flir_GT', help='save results to project/name')
